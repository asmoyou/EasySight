from sqlalchemy import Column, Integer, String, Boolean, Float, DateTime, Text, JSON, Enum
...
class MediaProxy(Base):
    ...
    def __repr__(self):
        return f"<MediaProxy(id={self.id}, name='{self.name}', ip='{self.ip_address}:{self.port}', online={self.is_online})>"