"""Add version field to AIModel

Revision ID: 6b6920f67f2d
Revises: a9c69ffb6efd
Create Date: 2025-07-23 20:00:32.114350
...
revision = '6b6920f67f2d'
down_revision = 'a9c69ffb6efd'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.drop_table('roles')
    op.add_column('ai_models', sa.Column('version', sa.String(length=20), nullable=True, comment='模型版本'))
