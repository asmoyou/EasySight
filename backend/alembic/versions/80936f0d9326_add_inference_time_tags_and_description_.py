"""Add inference_time, tags and description to AIModel

Revision ID: 80936f0d9326
Revises: 6b6920f67f2d
Create Date: 2025-08-07 11:29:30.945453
...
revision = '80936f0d9326'
down_revision = '6b6920f67f2d'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('ai_models', sa.Column('inference_time', sa.Float(), nullable=True, comment='推理时间(ms)'))
    op.add_column('ai_models', sa.Column('tags', sa.JSON(), nullable=True, comment='标签列表'))
    op.add_column('ai_models', sa.Column('description', sa.Text(), nullable=True, comment='模型描述'))
...
def downgrade() -> None:
    ...
    op.drop_column('ai_models', 'inference_time')
    # 先创建被引用的表
